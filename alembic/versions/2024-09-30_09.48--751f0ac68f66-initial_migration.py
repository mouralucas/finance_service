...
Revision ID: 751f0ac68f66
Revises: 
Create Date: 2024-09-30 09:48:19.299818
...
def upgrade() -> None:
    ...
    sa.Column('previous_balance', sa.DECIMAL(precision=10, scale=2), nullable=False),
    sa.Column('incoming', sa.DECIMAL(precision=10, scale=2), nullable=False),
    sa.Column('outgoing', sa.DECIMAL(precision=10, scale=2), nullable=False),
    sa.Column('transactions', sa.DECIMAL(precision=10, scale=2), nullable=False),
    sa.Column('earnings', sa.DECIMAL(precision=10, scale=2), nullable=False),
    ...
    sa.Column('amount', sa.Float(), nullable=False),
    sa.Column('contracted_rate', sa.String(length=50), nullable=False),
    sa.Column('currency_id', sa.String(length=3), nullable=False),
