...
def get_brazilian_fund_investment_statement_mock():
    ...
    for idx, period in enumerate(get_period_range(investment_period, get_previous_period())):
        ...
        contribution = 0 # May add a new investment, then check the period with the investment period
