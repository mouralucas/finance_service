    ...
    active_investments: list[dict[str, Any]] = [
        {
            **default_model_dict,
            ...
            + relativedelta(years=1, months=0, days=17),
            "quantity": 1.02,
            "price": 150.65,
            "amount": 1.02 * 150.65,
        ...
        },
        {
            **default_model_dict,
            ...
            "type_id": investment_types[0]["id"],
            "transaction_date": datetime.date.today()
            - relativedelta(years=4, months=7, days=28),
            "maturity_date": datetime.date.today()
            + relativedelta(years=0, months=11, days=9),
            "quantity": 998.3,
            "price": 1.50,
            "amount": 998.3 * 1.50,
        ...
        },
        {
            **default_model_dict,
            ...
            "transaction_date": datetime.date.today()
            - relativedelta(years=1, months=0, days=15),
            "maturity_date": datetime.date.today()
            + relativedelta(years=1, months=1, days=9),
            "quantity": 1,
            "price": 1100,
            "amount": 1100 * 1,
        ...
        },
        {
            **default_model_dict,
            ...
            "transaction_date": datetime.date.today()
            - relativedelta(years=0, months=0, days=15),
            "maturity_date": datetime.date.today()
            + relativedelta(years=2, months=3, days=0),
            "quantity": 1,
            "price": 1000,
            "amount": 1000 * 1,
    ...
    settled_investments: list[dict[str, Any]] = [
        {
            **default_model_dict,
            ...
            "type_id": investment_types[0]["id"],
            "transaction_date": datetime.date.today()
            - relativedelta(years=2, months=0, days=0),
            "maturity_date": datetime.date.today(),
            "quantity": 1.02,
            "price": 150.65,
            "amount": 1.02 * 150.65,
        ...
        },
        {
            **default_model_dict,
            ...
            "type_id": investment_types[0]["id"],
            "transaction_date": datetime.date.today()
            - relativedelta(years=4, months=0, days=28),
            "maturity_date": datetime.date.today(),
            "quantity": 998.3,
            "price": 1.50,
            "amount": 998.3 * 1.50,
