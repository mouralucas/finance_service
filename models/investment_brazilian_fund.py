...
class InvestmentBrazilianFundsModel(InvestmentBase):
    ...
    investment_quotation_date: Mapped[date] = mapped_column('investment_quotation_date',
                                                            doc='The day the investment was quoted')
    investment_settlement_date: Mapped[date] = mapped_column('liquidation_settlement_date',
...
class InvestmentBrazilianFundsStatementModel(InvestmentStatementBaseModel):
    ...
    fund_id: Mapped[uuid.UUID] = mapped_column(ForeignKey('funds_br.id'))
    contribution: Mapped[Decimal] = mapped_column('contribution', Numeric(precision=18, scale=8), default=0.0,
                                                  doc='The amount of money contributed to the fund in the period')
    price: Mapped[Decimal] = mapped_column('price', Numeric(precision=18, scale=8),
                                           doc='The price of the fund in the reference day')
    penalty: Mapped[Decimal] = mapped_column('penalty', Numeric(precision=18, scale=8), default=0.0,
