...
@router.post(
    ...
    description="Create a new credit card for the user",
...
async def create_credit_card(
    ...
    return await CreditCardService(session=session, user=user).create_credit_card(
        credit_card
    )


@router.patch(
    "/cancel", summary="Cancel a credit card", description="Cancel a credit card"
)
...
@router.get(
    "/bill/history",
    summary="Get credit card bill",
    description="Get credit card bill for all cards available for the period range",
)
async def get_bill_history(
    ...
    return await CreditCardService(session, user).get_credit_card_bill_history(
        params=params
    )
