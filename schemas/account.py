...
class AccountTypeSchema(BaseModel):
    ...
    id: uuid.UUID = Field(
        ...,
        serialization_alias="accountTypeId",
        description="The unique identification of the account type",
    )
...
class AccountTransactionSchema(BaseModel):
    ...
    id: int = Field(
        ..., serialization_alias="transactionId", description="Unique transaction ID"
    )
    ...
    account_id: uuid.UUID = Field(
        ..., serialization_alias="accountId", description="Account identification"
    )
    account_nickname: str | None = Field(
        None,
        serialization_alias="accountNickname",
    ...
    transaction_date: datetime.date = Field(
        ..., serialization_alias="transactionDate", description="Transaction date"
    )
    # category object
    category_id: uuid.UUID = Field(
        ..., serialization_alias="categoryId", description="Transaction category"
    )
    ...
    transaction_currency_id: str = Field(
        ...
        description="Transaction currency identification",
    )
    ...
    transaction_amount: float = Field(
        ..., serialization_alias="transactionAmount", description="Transaction amount"
    )
    exchange_rate: float | None = Field(
        None, serialization_alias="exchangeRate", description="Exchange rate"
    )
    tax_perc: float | None = Field(
        None, serialization_alias="taxPerc", description="Tax percentage"
    )
    tax: float | None = Field(None, serialization_alias="tax", description="Tax amount")
    spread_perc: float | None = Field(
        None, serialization_alias="spreadPerc", description="Spread percentage"
    )
    spread: float | None = Field(
        None, serialization_alias="spread", description="Spread amount"
    )
    effective_rate: float | None = Field(
        None, serialization_alias="effectiveRate", description="Effective rate"
    )
...
class AccountBalanceSchema(BaseModel):
    ...
    # id: uuid.UUID = Field(..., serialization_alias='balanceId',
    #   description='The id of the balance')
    # account_id: uuid.UUID = Field(..., serialization_alias='accountId',
    ...
    incoming: float = Field(
        0, description="The amount o money that enter the account in the period"
    )
    outgoing: float = Field(
        0, description="The amount o money that leave the account in the period"
    )
    transactions: float = Field(
        0, description="The difference between incoming and outgoing"
    )
    earnings: float = Field(
        0, description="How much the account profits in the period, if set"
    )
    balance: float = Field(
        0, description="How many money is in the account by the end of the period"
    )
