...
class CreateAccountTransactionRequest(BaseModel):
    ...
    exchange_rate: Decimal = Field(None, alias="exchangeRate", description="The exchange rate for international transactions")
    ...
    effective_rate: Decimal = Field(None, alias="effectiveRate", description="The effective rate of the transaction")
