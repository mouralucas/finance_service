...
class CreateAccountRequest(DefaultModel):
    ...
    nickname: str = Field(
        ..., alias="nickname", description="The nickname of the account"
    )
    description: str | None = Field(
        None, alias="description", description="The description of the account"
    )
    branch: str | None = Field(
        None, alias="branch", description="The branch of the account"
    )
    number: str | None = Field(
        None, alias="number", description="The number of the account"
    )
    open_date: datetime.date | None = Field(
        None, alias="openDate", description="The open date of the account"
    )
    close_date: datetime.date | None = Field(
        None, alias="closeDate", description="The close date of the account"
    )
    type_id: uuid.UUID = Field(
        ..., alias="accountTypeId", description="The type of the account"
    )
    currency_id: str = Field(
        ..., alias="currencyId", description="The currency of the account"
    )
...
class CloseAccountRequest(DefaultModel):
    ...
    close_date: datetime.date | None = Field(
        None, description="The close date of the account"
    )
...
class CreateAccountTransactionRequest(DefaultModel):
    ...
    amount: Decimal = Field(
        ..., description="The amount of the transaction in the account currency"
    )
    ...
    transaction_amount: Decimal | None = Field(
        None, description="The amount in the transaction currency"
    )
    exchange_rate: Decimal | None = Field(
        None, description="The exchange rate for international transactions"
    )
    ...
    effective_rate: Decimal | None = Field(
        None, description="The effective rate of the transaction"
    )

    origin: str = Field("SYSTEM", description="The origin of the entry")
    is_validated: bool | None = Field(
        None, description="Whether the transaction is validated by the user"
    )
...
class UpdateAccountTransactionRequest(BaseModel):
    ...
    amount: Decimal | None = Field(
        None, description="The amount of the transaction in the account currency"
    )
...
class CreateBalanceRequest(DefaultModel):
    account_id: uuid.UUID = Field(..., description="The id of the account")
    start_period: int | None = Field(
        None, description="The start period of the balance"
    )
