...
class GetTaxFeeRequest(BaseModel):
    ...
    country_id: str = Field(
        "BR", description="The id of the country for the tax or fee"
    )
...
class TaxFeeRequest(BaseModel):
    ...
    id: uuid.UUID = Field(
        ..., alias="taxFeeId", description="The identification of the tax/fee"
    )
    amount: Decimal = Field(..., description="The amount of the tax/fee")
    currency_id: str = Field(
        "BRL", alias="currencyId", description="The currency of the tax/fee"
    )
...
class TaxFeeQuotationRequest(BaseModel):
    ...
    Created by: Lucas Penha de Moura - 19/03/2025
        This model define the request for the tax/fee
            quotation details for the investment.
...
class CreateBrazilianFundRequest(BaseModel):
    ...
    fees: list[TaxFeeQuotationRequest] | None = Field(
