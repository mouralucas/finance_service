...
from schemas.request.investment import (
    CreateInvestmentBaseRequest,
    CreateInvestmentStatementBaseRequest,
)
...
class CreateBrazilianFundInvestmentRequest(CreateInvestmentBaseRequest):
    ...
    investment_quotation_date: date = Field(
        ..., description="The day that the investment was quoted"
    )
    ...
    redemption_quotation_date: date | None = Field(
        None, description="The day that the redemption was quoted"
    )
    redemption_settlement_date: date | None = Field(
        None, description="The day that the amount was settled"
    )


class CreateBrazilianFundInvestmentStatementRequest(
    CreateInvestmentStatementBaseRequest
):
    ...
    price: Decimal = Field(
        ..., description="The price of the fund in the reference day"
    )
    penalty: Decimal | None = Field(
        Decimal("0"), description="The penalty applied to the investment in the period"
    )
