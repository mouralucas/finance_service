...
def test_set_due_date():
    ...
    due_date = CreditCardService.set_due_date(
        transaction_date, close_day, due_day, return_str=True
    )
    ...
    # Test transaction ON teh closing day
    #   with closing in the month before the due date
    ...
    # Test transaction in same month as due
    #   and closing in the month before the due date
    ...
    # Test transaction before the closing day with
    #   closing in the month before the due date
